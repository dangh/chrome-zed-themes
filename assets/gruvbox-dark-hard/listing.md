...
Chrome in Zed's Gruvbox Dark Hard: title bar, tabs, toolbar and new tab page taken from the editor's own theme file.

## Description

Gruvbox Dark Hard, lifted straight from the Zed editor's theme file, so Chrome and Zed can
