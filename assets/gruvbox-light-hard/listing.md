...
Chrome in Zed's Gruvbox Light Hard: title bar, tabs, toolbar and new tab page taken from the editor's own theme file.

## Description

Gruvbox Light Hard, lifted straight from the Zed editor's theme file, so Chrome and Zed can
...
• The address bar is aimed at Zed's editor background
