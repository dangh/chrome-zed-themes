...
Chrome in Zed's One Dark: title bar, tabs, toolbar and new tab page taken from the editor's own theme file.

## Description

One Dark, lifted straight from the Zed editor's theme file, so Chrome and Zed can
