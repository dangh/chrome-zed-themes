...
Chrome in Zed's Ayu Dark: title bar, tabs, toolbar and new tab page taken from the editor's own theme file.

## Description

Ayu Dark, lifted straight from the Zed editor's theme file, so Chrome and Zed can
