...
Chrome in Zed's Gruvbox Light Soft: title bar, tabs, toolbar and new tab page taken from the editor's own theme file.

## Description

Gruvbox Light Soft, lifted straight from the Zed editor's theme file, so Chrome and Zed can
